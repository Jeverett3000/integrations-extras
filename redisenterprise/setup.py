...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'redisenterprise', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-redisenterprise',
    version=ABOUT['__version__'],
    description='The RedisEnterprise check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent redisenterprise check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Christian Mague',
    author_email='support@redislabs.com',
    # License
    ...
    packages=['datadog_checks.redisenterprise'],
