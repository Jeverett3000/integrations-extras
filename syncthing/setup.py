...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'syncthing', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-syncthing',
    version=ABOUT['__version__'],
    description='The Syncthing check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent syncthing check',
    ...
    packages=['datadog_checks.syncthing'],
