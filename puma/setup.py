...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'puma', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The puma check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent puma check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Justin Morris',
    author_email='justin.morris@ferocia.com.au',
    # License
