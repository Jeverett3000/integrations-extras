...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'cybersixgill_actionable_alerts', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-cybersixgill_actionable_alerts',
    version=ABOUT['__version__'],
    description='The cybersixgill_actionable_alerts check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent cybersixgill_actionable_alerts check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Farukh Shaik',
    author_email='fshaik@loginsoft.com',
    # License
