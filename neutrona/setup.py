...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'neutrona', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='datadog agent neutrona check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='David Flamini',
    author_email='david@neutrona.com',
    # License
    ...
    packages=['datadog_checks.neutrona'],
