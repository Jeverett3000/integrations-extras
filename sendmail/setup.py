...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'sendmail', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-sendmail',
    version=ABOUT['__version__'],
    description='The Sendmail check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent sendmail check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='David B.',
    author_email='david.bouchare@datadoghq.com',
    # License
    ...
    packages=['datadog_checks.sendmail'],
