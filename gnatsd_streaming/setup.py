...
setup(
    name='datadog-gnatsd_streaming',
    version=ABOUT['__version__'],
    description='The Gnatsd_streaming check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent gnatsd_streaming check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author_email='dev@goldstar.com',
    # License
    ...
    packages=['datadog_checks.gnatsd_streaming'],
