...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'tidb', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The tidb check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent tidb check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Yifan Xu',
    author_email='xuyifan02@pingcap.com',
    # License
