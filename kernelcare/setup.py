...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'kernelcare', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='datadog agent kernelcare check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Kernelcare',
    author_email='schvaliuk@cloudlinux.com',
    # License
    ...
    packages=['datadog_checks.kernelcare'],
