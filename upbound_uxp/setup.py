...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'upbound_uxp', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-upbound_uxp',
    version=ABOUT['__version__'],
    description='The Upbound UXP check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent upbound_uxp check',
    ...
    packages=['datadog_checks.upbound_uxp'],
