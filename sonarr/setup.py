...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'sonarr', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The Sonarr check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent sonarr check',
    ...
    packages=['datadog_checks.sonarr'],
