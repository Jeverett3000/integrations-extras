...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'hbase_regionserver', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-hbase_regionserver',
    version=ABOUT['__version__'],
    description='The HBase regionserver check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent hbase_regionserver check',
    ...
    packages=['datadog_checks.hbase_regionserver'],
