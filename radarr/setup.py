...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'radarr', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The Radarr check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent radarr check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Hadrien Patte',
    author_email='hadrien.patte@datadoghq.com',
    # License
    ...
    packages=['datadog_checks.radarr'],
