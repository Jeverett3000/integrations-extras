...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'octoprint', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='datadog agent octoprint check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Waldo',
    author_email='gwaldo@gmail.com',
    # License
    ...
    packages=['datadog_checks.octoprint'],
