...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'unifi_console', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-unifi_console',
    version=ABOUT['__version__'],
    description='The Unifi Console check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent unifi_console check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Antonin Bruneau',
    author_email='antonin.bruneau@gmail.com',
    # License
    ...
    packages=['datadog_checks.unifi_console'],
