...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'nn_sdwan', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-nn_sdwan',
    version=ABOUT['__version__'],
    description='The nn-sdwan check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent nn_sdwan check',
    ...
    packages=['datadog_checks.nn_sdwan'],
