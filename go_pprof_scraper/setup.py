...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'go_pprof_scraper', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-go_pprof_scraper',
    version=ABOUT['__version__'],
    description='The Go-pprof-scraper check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent go_pprof_scraper check',
    ...
    packages=['datadog_checks.go_pprof_scraper'],
