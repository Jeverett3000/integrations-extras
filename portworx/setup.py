...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'portworx', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='datadog agent portworx check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='CHANGE',
    author_email='CHANGEMAIL',
    # License
    ...
    packages=['datadog_checks.portworx'],
