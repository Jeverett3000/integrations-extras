...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'robust_intelligence_ai_firewall', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-robust_intelligence_ai_firewall',
    version=ABOUT['__version__'],
    description='The Robust Intelligence AI Firewall check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent robust_intelligence_ai_firewall check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Mayank Rajoria',
    author_email='contact@robustintelligence.com',
    # License
    ...
    packages=['datadog_checks.robust_intelligence_ai_firewall'],
