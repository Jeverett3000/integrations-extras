...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'scalr', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The Scalr check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent scalr check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Yurii',
    author_email='support@scalr.com',
    # License
