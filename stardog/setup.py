...
# Get version info
ABOUT = {}
with open(path.join(HERE, "datadog_checks", "stardog", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords="datadog agent stardog check",
    # The project's main homepage.
    url="https://github.com/DataDog/integrations-extras",
    # Author details
    author="support@stardog.com",
    ...
    packages=["datadog_checks.stardog"],
