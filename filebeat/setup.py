...
# Get version info
ABOUT = {}
with open(path.join(HERE, "datadog_checks", "filebeat", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords="datadog agent filebeat check",
    # The project's main homepage.
    url="https://github.com/DataDog/integrations-extras",
    # Author details
    author="CHANGENAME",
    author_email="CHANGEEMAIL",
    # License
    ...
    packages=["datadog_checks.filebeat"],
