...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'ns1', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='datadog agent ns1 check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Dragan Blagojevic',
    author_email='dblagojevic@daitan.com',
    # License
