...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'redpanda', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-redpanda',
    version=ABOUT['__version__'],
    description='The redpanda check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent redpanda check',
    ...
    packages=['datadog_checks.redpanda'],
