...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'exim', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The exim check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent exim check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Jean-Frédéric',
    author_email='JeanFred1@gmail.com',
    # License
