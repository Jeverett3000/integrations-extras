...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'trino', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The trino check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent trino check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='André Luís Anastácio',
    author_email='andreluisanastacio@gmail.com',
    # License
