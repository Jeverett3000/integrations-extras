...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'speedtest', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-speedtest',
    version=ABOUT['__version__'],
    description='The speedtest check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent speedtest check',
    ...
    packages=['datadog_checks.speedtest'],
